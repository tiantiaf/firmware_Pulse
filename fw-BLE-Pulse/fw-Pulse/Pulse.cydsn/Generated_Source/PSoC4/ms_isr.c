...
{
    #ifdef ms_isr_INTERRUPT_INTERRUPT_CALLBACK
        ms_isr_Interrupt_InterruptCallback();
    #endif /* ms_isr_INTERRUPT_INTERRUPT_CALLBACK */ 
...
*
*   Note calling ms_isr_Start or ms_isr_StartEx will 
*   override any effect this API would have had. This API should only be called
*   after ms_isr_Start or ms_isr_StartEx has been called. 
