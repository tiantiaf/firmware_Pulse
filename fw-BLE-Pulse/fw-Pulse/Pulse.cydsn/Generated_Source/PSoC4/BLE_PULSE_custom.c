...
const CYBLE_CUSTOMS_T cyBle_customs[0x01u] = {
    ...
    /* BT_PULSE service */
    {
        0x000Eu, /* Handle of the BT_PULSE service */ 
        {

            /* CTR_LED characteristic */
            {
                0x0010u, /* Handle of the CTR_LED characteristic */ 
            ...
            /* CTR_MOTOR characteristic */
            {
                0x0013u, /* Handle of the CTR_MOTOR characteristic */ 
            ...
            /* PULSE_DATA characteristic */
            {
                0x0016u, /* Handle of the PULSE_DATA characteristic */ 
