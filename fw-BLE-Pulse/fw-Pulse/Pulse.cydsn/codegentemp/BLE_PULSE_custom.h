...
#define CYBLE_BT_PULSE_SERVICE_INDEX   (0x00u) /* Index of BT_PULSE service in the cyBle_customs array */
#define CYBLE_BT_PULSE_CTR_LED_CHAR_INDEX   (0x00u) /* Index of CTR_LED characteristic */
#define CYBLE_BT_PULSE_CTR_LED_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
#define CYBLE_BT_PULSE_CTR_MOTOR_CHAR_INDEX   (0x01u) /* Index of CTR_MOTOR characteristic */
#define CYBLE_BT_PULSE_CTR_MOTOR_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
#define CYBLE_BT_PULSE_PULSE_DATA_CHAR_INDEX   (0x02u) /* Index of PULSE_DATA characteristic */
#define CYBLE_BT_PULSE_PULSE_DATA_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */
#define CYBLE_BT_PULSE_PULSE_DATA_CUSTOM_DESCRIPTOR_DESC_INDEX   (0x01u) /* Index of Custom Descriptor descriptor */


#define CYBLE_BT_PULSE_SERVICE_HANDLE   (0x000Eu) /* Handle of BT_PULSE service */
#define CYBLE_BT_PULSE_CTR_LED_DECL_HANDLE   (0x000Fu) /* Handle of CTR_LED characteristic declaration */
#define CYBLE_BT_PULSE_CTR_LED_CHAR_HANDLE   (0x0010u) /* Handle of CTR_LED characteristic */
#define CYBLE_BT_PULSE_CTR_LED_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0011u) /* Handle of Characteristic User Description descriptor */
#define CYBLE_BT_PULSE_CTR_MOTOR_DECL_HANDLE   (0x0012u) /* Handle of CTR_MOTOR characteristic declaration */
#define CYBLE_BT_PULSE_CTR_MOTOR_CHAR_HANDLE   (0x0013u) /* Handle of CTR_MOTOR characteristic */
#define CYBLE_BT_PULSE_CTR_MOTOR_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0014u) /* Handle of Characteristic User Description descriptor */
#define CYBLE_BT_PULSE_PULSE_DATA_DECL_HANDLE   (0x0015u) /* Handle of PULSE_DATA characteristic declaration */
#define CYBLE_BT_PULSE_PULSE_DATA_CHAR_HANDLE   (0x0016u) /* Handle of PULSE_DATA characteristic */
#define CYBLE_BT_PULSE_PULSE_DATA_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0017u) /* Handle of Client Characteristic Configuration descriptor */
#define CYBLE_BT_PULSE_PULSE_DATA_CUSTOM_DESCRIPTOR_DESC_HANDLE   (0x0018u) /* Handle of Custom Descriptor descriptor */
